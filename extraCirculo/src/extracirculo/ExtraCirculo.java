...
public class ExtraCirculo {
    ...
    //Codifica un programa que calcule la longitud, area y volumen de un cÃ­rculo
    public static void main(String[] args) {
        ...
        do{
            ...
            while(!leer.hasNextInt()){ //No pueden ser letras
                System.out.print("Introduce el radio del círculo: ");
                leer.next(); 
            }
        ...
        System.out.println("\n- El área del círculo es de "
                ...
                + " unidades.\n- El volumen del círculo es de " 
                + (4/3 * Math.PI * Math.pow(r,3))  
                + " unidades.\n- La longitud del círculo es de " 
                + (2 * Math.PI * r) 
                + " unidades."
        );
    } 
